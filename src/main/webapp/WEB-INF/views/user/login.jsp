		...
		<div class="page-container">
			<div class="login-form-container shadow">
				<div class="login-form-right-side" style="position: relative;">
					<img style="height: 100%; width: 100%; position: absolute; right: 0px; border-radius: 10px 0 0 10px;" src="./img/photo-1501067486956-e9a0bd9c2b46 (1).jfif" alt="">
				</div>
				<!-- 로그인 입력창 -->
				<div class="login-form-left-side login-div">
					...
					<div class="login-btn-wrap">
						...
						<a href="#" style="width: 95px; height: 35px;">
							<img src="./img/kakao_login_medium.png"style="margin: 0 0 0; height: 100%; width: 100%;" alt="">
						</a>
						<span style="margin-top: 10px;"><a style="cursor: pointer;" onclick="idFind();">아이디 찾기</a> / <a style="cursor: pointer;" onclick="pwdFind();">비밀번호 찾기</a></span> <span style="margin-top: 10px;"><a href="#">회원가입</a></span>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="login-form-left-side idFind-div" align="center" style="display: none;">
		<form action="#">
			<div class="login-input-container">
				...
				<div class="login-input-wrap input-password">
					<i class="far fa-envelope" style="color: #607a6a;"></i>
					<input style="width: 200px;" placeholder="EMAIL을 입력하세요." type="text">
					<button class="btn btn-default btn-sm" onclick="emailAccredit();">인증하기</button>
				</div>
				<div class="login-input-wrap email-accredit" style="display: none;">
					<i class="far fa-envelope" style="color: #607a6a;"></i>
					<input placeholder="인증코드를 작성하세요." type="text">
				</div>
