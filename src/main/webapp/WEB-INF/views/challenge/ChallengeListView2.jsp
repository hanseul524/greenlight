  ...
  <div class="container">
    <div class="category">
      <c:url var="cList" value="ChallengeListView.do">
      	<c:param name="categoryNo" value="${challenge.categoryNo eq max}"></c:param>
      </c:url>
      <span class="menubar"><a href="${cList }">참여하기</a></span>
      <c:url var="cList" value="ChallengeListView.do">
      	<c:param name="categoryNo" value="${challenge.categoryNo eq max - 1}"></c:param>
      </c:url>
      <span class="menubar"><a href="${cList }">지난 챌린지</a></span>
      <c:url var="cList" value="ChallengeListView.do">
      	<c:param name="categoryNo" value="${challenge.categoryNo eq max - 2}"></c:param>
      </c:url>
      <span class="menubar"><a href="${cList }">지난 챌린지</a></span>
      <c:url var="cList" value="ChallengeListView.do">
      	<c:param name="categoryNo" value="${challenge.categoryNo}"></c:param>
      </c:url>
      <span class="menubar"><a href="${cList }">All</a></span>
...
<%-- 	    <input type="hidden" value="${challenge.categoryNo }" name="categoryNo"> --%>
	    <c:if test="${challenge.categoryNo eq max}"> <!-- 현재 진행중 -->
		    <ul class="box">
		      <li class="item">
		        <div class="box-inner">
	    ...
	    <c:if test="${challenge.categoryNo eq max - 1}"> <!-- 지난 챌린지 -->
		    <ul class="box">
		      <li class="item">
		        <div class="box-inner">
		        <c:if test="${challenge.fileMain eq 'Y' }">
	     ...
	     <c:if test="${challenge.categoryNo eq max - 2}"> <!-- 지지난 챌린지 -->
		    <ul class="box">
		      <li class="item">
		        <div class="box-inner">
		        <c:if test="${challenge.fileMain eq 'Y' }">
	     ...
	     <c:if test="${challenge.categoryNo }"> <!-- 전체 챌린지 -->
		    <ul class="box">
		      <li class="item">
		        <div class="box-inner">
		        <c:if test="${challenge.fileMain eq 'Y' }">
