...
<jsp:include page="/common/header.jsp"></jsp:include>
  <div class="container">
    <div class="category">
      <span class="menubar"><input type="button" name="button" id="button" value="${challenge.categoryNo eq max }">참여하기</span>
      <span class="menubar"><input type="button" name="button" id="button" value="${challenge.categoryNo eq max - 1}">지난 챌린지</span>
      <span class="menubar"><input type="button" name="button" id="button" value="${challenge.categoryNo eq max - 2}">지난 챌린지</span>
      <span class="menubar"><input type="button" name="button" id="button" value="${challenge.categoryNo}">All</span>
