...
<jsp:include page="/common/header.jsp"></jsp:include>
    ...
    <div class="nav-admin">
      ...
      <div class="nav-inner">
		...
		<div class="contents">
			<div class="con-title">
				<form action="onlineShopUpdateWriteView.do" method="post" enctype="multipart/form-data">
					<div>온라인 매장</div>
			...
			<input type="hidden" name="shopImage" value="${onlineShop.shopImage }">
				<fieldset style="border: 0px; display: inline-block;">
					<legend style="width: 100%; height: 100px;">
						...
						<div class="div-auction">
							<input type="text" class="auction-input" name="shopName" id="auctionTitle" value="${onlineShop.shopName }" readonly>
						</div>
					</legend>
				</fieldset>
				<fieldset
					...
					<legend style="width: 100%; height: 100px;">
						...
						<select name="category" style="font-size: 12px; margin-top: 8px;">
							<c:if test="${onlineShop.category == 'ZEROWASTE' }">
								<option value="ZEROWASTE" >ZEROWASTE</option>
							</c:if>
							 <c:if test="${onlineShop.category == 'UPCYCLING' }">
				...
				<fieldset style="border: 0px; margin-bottom: 20px;">
					<legend style="width: 100%; height: 100px;">
						...
						<div class="div-auction">
							<input type="text" class="auction-input" name="shopContents" id="offlineAddr" style="width: 500px; float: left;" value="${onlineShop.shopContents }" readonly>
				...
				<fieldset style="border: 0px;">
					<legend style="width: 100%; height: 100px;">
						<p>매장 링크</p>
						<div class="div-auction">
							<input type="text" class="auction-input" name="shopAddress" id="auctionPrice" value="${onlineShop.shopAddress }" readonly>
						</div>
					</legend>
				</fieldset>
				<div class="mainImage">
